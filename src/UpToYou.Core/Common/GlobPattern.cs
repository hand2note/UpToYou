...
RelativeGlob: IEquatable<RelativeGlob> {
...
GlobHelper {
    ...
    private static readonly ConcurrentDictionary<string, Glob> 
    GlobCache = new ConcurrentDictionary<string, Glob>();
    ...
    public static IEnumerable<RelativePath> 
    GetMatchingFilesRelative(this string directory, List<RelativeGlob> globs) {
